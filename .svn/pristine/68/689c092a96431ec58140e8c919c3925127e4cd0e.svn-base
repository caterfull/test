$(document).ready(function () {
    ...
    if (!localStorage.getItem('activeStep')) {
        ...
        switch ($activeStep) {
            ...
            case "2":
                ...
                var items_url = '/'+model_name+'/' + localStorage.getItem('proposalId') + '/items';
    ...
    function step3Settings() {
        ...
        var confirm_url = '/'+model_name+'/' + localStorage.getItem('proposalId');
                ...
                if (eventId == -1) {
                    ...
                    $.ajax({
                            ...
                            success: function (data, textStatus) {
                                ...
                                }else if(model_name == 'invoice'){
                                     localStorage.setItem('proposalId', data.invoice_id);
                                    proposal_id = data.invoice_id;
                                }else{
                                   alert("error");
                                }
...
//                                var proposal_id = data.proposal_id;
                                var items_url = '/'+model_name+'/' + proposal_id + '/items';
                                $.get(items_url, '', function (data) {
                                    $('#stepContainer2').append(data);
    ...
    $('.btn-prev').click(function (event) {
        ...
        switch ($activeStep) {
            ...
            case "2":
                ...
                var event_url = '/'+model_name+'/' + localStorage.getItem('proposalId') + '/event/';
