...
from base.views.invoice import ProposalEvent, ProposalItemsView, ProposalView, ItemView, ItemDelete, ProposalAccept, \
    ProposalDeny, ProposalEmailSend, InvoiceView, InvoiceEvent, InvoiceEmailSend, \
    ProposalDeleteView, InvoiceDeleteView, invoice_downloadpdf, proposal_downloadpdf
from base.views.stripe_views import StripeAuthorizeView, StripeCallbackView, StripeSubscribeView, InvoiceCharge
...
urlpatterns = [
    ...
    url(r'^business/stripe/subscribe/(?P<business_id>\d+)/$', StripeSubscribeView.as_view(), name='stripe_subscribe'),
